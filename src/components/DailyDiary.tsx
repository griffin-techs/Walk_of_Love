...
const STORAGE_KEY = "daily-love-diary-v2";
...
const seedEntries: DiaryEntry[] = [
  ...
  },
  {
    ...
    comments: [
      ...
      },
      {
        id: crypto.randomUUID(),
        author: "Partner",
        body: "Already booked it for you 💙",
        createdAt: new Date().toISOString(),
      },
    ],
    likes: 7,
    ...
    comments: [
      {
        id: crypto.randomUUID(),
        author: "Partner",
        body: "I miss you too, but we're almost there.",
        createdAt: new Date().toISOString(),
      },
    ],
    likes: 6,
  ...
  },
  {
    ...
    body: "You spun me around and suddenly the world felt like just us and this song.",
    moods: ["Happy", "Loved"],
  ...
  },
  {
    ...
    body: "Outside was cold and grey. Inside was warm tea, blankets, and you. Perfect.",
    moods: ["Calm", "Loved", "Grateful"],
    tags: ["comfort", "weather"],
    comments: [],
    likes: 11,
    createdAt: new Date().toISOString(),
  },
  {
    ...
    title: "First fight resolution",
    body: "We fought but didn't run. We talked, listened, and chose each other again.",
    moods: ["Grateful", "Calm"],
    ...
    comments: [
      {
        id: crypto.randomUUID(),
        author: "You",
        body: "I'm glad we handled that well together.",
        createdAt: new Date().toISOString(),
      },
    ],
    likes: 10,
  ...
  },
  {
    ...
    title: "You remembered that detail",
    body: "I mentioned liking a coffee once weeks ago. You showed up with it today.",
    moods: ["Loved", "Happy"],
    tags: ["thoughtfulness", "attention"],
    comments: [],
    likes: 6,
    createdAt: new Date().toISOString(),
  },
  {
    ...
    body: "No fancy restaurant. Just handwritten notes hidden everywhere for me to find.",
    moods: ["Loved", "Happy", "Grateful"],
    tags: ["valentine", "surprise"],
    comments: [
      {
        id: crypto.randomUUID(),
        author: "You",
        body: "Did you find the last one in your pillow?",
        createdAt: new Date().toISOString(),
      },
      {
        id: crypto.randomUUID(),
        author: "Partner",
        body: "Yes and I cried 😭💙",
        createdAt: new Date().toISOString(),
      },
    ],
    likes: 12,
  ...
  },
  {
    ...
    title: "New year, same forever",
    body: "Made resolutions together. Every single one includes you in some way.",
    moods: ["Loved", "Grateful", "Happy"],
    tags: ["new-year", "goals", "future"],
    comments: [],
    likes: 5,
    createdAt: new Date().toISOString(),
  },
  {
    ...
    body: "Started the year unsure. Ending it so certain. Thank you for this.",
    ...
    comments: [
      {
        id: crypto.randomUUID(),
        author: "Partner",
        body: "Here's to next year with you.",
        createdAt: new Date().toISOString(),
      },
    ],
    likes: 13,
  ...
  },
  {
    ...
    body: "They welcomed me like I was always meant to be there. Your mom's laugh is exactly like yours.",
    moods: ["Happy", "Calm"],
...
export function DailyDiary() {
  ...
  function likeEntry(entryId: string) {
    setEntries((prev) =>
      prev.map((entry) => {
        if (entry.id !== entryId) {
          return entry;
  ...
  return (
    <div className="w-full px-4 py-12 md:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <section className="mb-6 mt-6 grid gap-4 rounded-2xl border border-amber-200 bg-white p-5 shadow-sm md:grid-cols-4">
        ...
        <section className="mb-6 rounded-2xl border border-amber-200 bg-white p-5 shadow-sm">
          <h3 className="mb-3 text-lg font-semibold text-slate-900">Create diary entry</h3>
        ...
        <section className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
          ...
          <aside className="rounded-2xl border border-amber-200 bg-white p-5 shadow-sm">
            {!selectedEntry ? (
              ...
              <div>
                <h4 className="text-lg font-semibold text-slate-900">{selectedEntry.title}</h4>
                ...
                <div className="mt-4 flex gap-2">
                  <button
                    onClick={() => likeEntry(selectedEntry.id)}
